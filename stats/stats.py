...
class Statistics:
    ...
    async def retrieve_statistics(self):
        ...
        cl = "***Updates:***\n***`The bot has been moved to another vps this one has better cpu and memory Dw too much about speed` 🚶***\n\n***Revamped:***  **Audio (Np,song and queue cmds added np tiles Ec More updates to this in future)**\n***Fixed:*** **Playlist append, repeat song(removed),And more errors i probs forgot about LUL**\n\n***+Planned :***\n**Np Tiles and np delete toggleable and channel setable, Fun cog containing fun cmds like Slap, bang, shoot etc**\n\n\n***`This is the end of Changelog As of 2/21/2017(12:25am)Eastern Caribbean`***\n═══════════════  ஜ۩۞۩ஜ  ═══════════════"
        list = []
